...
/**
 * An <code>InterpolatorCallback</code> using the Java system properties
 * as a source and a default prefix of "system.".
 *
 * @author Tom Mahaffey
 */
public final class SystemPropertiesInterpolatorCallback
  ...
  public SystemPropertiesInterpolatorCallback(String prefix) {
